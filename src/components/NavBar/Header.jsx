    ...
    return (
        <>
            ...
            <nav class=" flex flex-row justify-between p-4   items-center ">
                <img class="h-7 w-7" src="./src/assets/shared/logo.svg" alt="" srcset="" />
                <details class="z-30" >
                    <summary class="inline " onClick={() => setHamburgerIsOpen(!hamburgerIsOpen)}>
                        {hamburgerIsOpen ? (

                            <img class="h-4 w-4 " src="icon-close.svg" />
                        ):(
                            <img class="h-4 w-4 " src="src\assets\shared\icon-hamburger.svg" />
                        )}
                    </summary>
