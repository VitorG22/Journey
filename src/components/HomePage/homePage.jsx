        ...
        <>
            ...
            ">
                ...
                '>
                    ...
                    <h1 class="homePageItem  text-6xl md:text-9xl ">SPACE</h1>
                    ...
                    {windowWidht != "desktop" ? (<button onClick={() => setPageSelected("destination")} class=" homePageItem bg-neutral-300 text-slate-950 h-32 w-32 rounded-full mt-8 ">EXPLORE</button>) : ("")}
                </div>
                {windowWidht == "desktop" ? (<button onClick={() => setPageSelected("destination")} class=" homePageItem bg-neutral-300 text-slate-950 h-56 w-56 rounded-full text-2xl mr-[20vw] ">EXPLORE</button>) : ("")}
            </section>
